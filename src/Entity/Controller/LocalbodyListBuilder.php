...
namespace Drupal\cntry_ste_dst_la_lb_wrd\Entity\Controller;
...
/**
 * Provides a list controller for localbodylist entity.
 *
 * @ingroup cntry_ste_dst_la_lb_wrd
 */
class LocalbodylistBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Localbody Entity implements a Localbody model.'),
    ];
