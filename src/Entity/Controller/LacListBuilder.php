...
/**
 * Provides a list controller for laclist entity.
 *
 * @ingroup cntry_ste_dst_la_lb_wrd
 */
class LaclistBuilder extends EntityListBuilder {
  ...
  public function render() {
    $build['description'] = [
      '#markup' => $this->t('Lac Entity implements a Lac model.'),
    ];
