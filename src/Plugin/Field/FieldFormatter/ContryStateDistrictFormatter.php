...
/**
 * Plugin implementation of the 'contry_state_district_formatter' formatter.
 *
 * @FieldFormatter(
 *   id = "contry_state_district_formatter",
 *   label = @Translation("Contry state district formatter"),
 *   field_types = {
 *     "cntry_ste_dst_la_lb_wrd_type"
 *   }
 * )
 */
class ContryStateDistrictFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
